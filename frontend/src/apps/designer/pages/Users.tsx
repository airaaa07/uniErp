...
const Users: React.FC = () => {
  ...
  const getRoleChipColor = (roleName: string) => {
    ...
    if (name.includes('admin')) return { bg: 'rgba(99, 102, 241, 0.08)', text: '#4f46e5' };
    if (name.includes('designer')) return { bg: 'rgba(6, 182, 212, 0.08)', text: '#0891b2' };
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 1 }}>
      ...
      >
        ...
        <Button variant="contained" startIcon={<AddIcon />} onClick={() => handleOpenDialog()} sx={{ borderRadius: 2.5 }}>
          Add User
        </Button>
      </Box>
            ...
            {loading ? (
              ...
              users.map((user) => (
                ...
                >
                  ...
                  <TableCell>
                    <Chip
                      icon={user.is_active ? <CheckCircleOutlined sx={{ fontSize: '1rem !important' }} /> : undefined}
                  ...
                  <TableCell align="right">
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 0.5 }}>
                      <IconButton
                        ...
                        size="small"
                        title="Edit User"
                        sx={{ color: 'primary.main', bgcolor: 'rgba(79, 70, 229, 0.04)', '&:hover': { bgcolor: 'rgba(79, 70, 229, 0.08)' } }}
                      >
